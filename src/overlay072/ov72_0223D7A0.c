...
int ov72_0223D7A0 (UnkStruct_020067E8 * param0, int * param1)
{
    ...
    case 0:
...

        {
            ...
            v0->unk_0C = (Options *)Save_PlayerData_GetOptionsAddr((UnkStruct_021C0794 *)sub_02006840(param0));
        }
...
static void ov72_0223DCA8 (UnkStruct_ov72_0223DB98 * param0, NARC * param1)
{
    ...
    sub_0200DD0C(v0, 0, 1, 10, Options_GetFrame(param0->unk_0C), 39);
...
static void ov72_0223E930 (UnkStruct_ov72_0223DB98 * param0, int param1)
{
    ...
    param0->unk_38 = sub_0201D738(&param0->unk_338, 1, param0->unk_34, 0, 0, Options_GetTextFrameDelay(param0->unk_0C), NULL);
}
