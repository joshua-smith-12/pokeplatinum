...
void sub_02039298 (UnkStruct_021C0794 * param0, int param1, int param2, int param3, int param4)
{
    ...
    PlayerProfile * v2 = sub_02032EE8(param1);
    DWCFriendData * v3;
    Strbuf* v4;
    ...
    if (param4 == 0) {
        v4 = PlayerProfile_GetName_NewString(v2, param3);
        sub_0202AF0C(v0, param2, v4);
        Strbuf_Free(v4);
        sub_0202AE2C(v0, param2, 8, PlayerProfile_GetGender(v2));
        sub_0202AE2C(v0, param2, 0, PlayerProfile_GetTrainerID(v2));
    } else if (param4 == 1) {
    ...
    Strbuf_Free(v4);
    sub_0202AE2C(v0, param2, 7, PlayerProfile_GetAvatar(v2));
    sub_02033114(param0);
}
