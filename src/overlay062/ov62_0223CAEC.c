...
typedef struct {
    ...
    int unk_1C;
    int unk_20;
    UnkStruct_0205AA50 unk_24[6];
    UnkStruct_0205AA50 unk_84[2];
...
static void ov62_0223CF2C (UnkStruct_0208C06C * param0)
{
    ...
    for (v3 = 0; v3 < 2; v3++) {
        v1 = &v0->unk_84[v3];
        sub_0201A7E8(param0->unk_14.unk_10, v1, 6, Unk_ov62_02248EA0[v3][0], Unk_ov62_02248EA0[v3][1], Unk_ov62_02248EA0[v3][2], Unk_ov62_02248EA0[v3][3], 14, v2);
...
static void ov62_0223D004 (UnkStruct_0208C06C * param0)
{
    ...
    for (v3 = 0; v3 < v6; v3++) {
        ...
        if (v0->unk_1C == 0) {
            sub_0201A7E8(param0->unk_14.unk_10, v1, 2, Unk_ov62_02248EC0[v3][0], Unk_ov62_02248EC0[v3][1], Unk_ov62_02248EC0[v3][2], Unk_ov62_02248EC0[v3][3], 14, v2);
            v2 += (Unk_ov62_02248EC0[v3][2] * Unk_ov62_02248EC0[v3][3]);
        } else {
            sub_0201A7E8(param0->unk_14.unk_10, v1, 2, Unk_ov62_02248EE0[v3][0], Unk_ov62_02248EE0[v3][1], Unk_ov62_02248EE0[v3][2], Unk_ov62_02248EE0[v3][3], 14, v2);
...
static void ov62_0223D3A8 (UnkStruct_0208C06C * param0, int param1)
{
    ...
    if (param1 == 0) {
        sub_0200D3F4(v0->unk_A4[0].unk_08, 1);
        sub_020129D0(v0->unk_A4[0].unk_0C, 1);
        sub_0200D4C4(v0->unk_A4[1].unk_08, 128, 232);
    } else {
        sub_0200D3F4(v0->unk_A4[0].unk_08, 0);
        sub_020129D0(v0->unk_A4[0].unk_0C, 0);
        sub_0200D4C4(v0->unk_A4[1].unk_08, 80, 232);
    }
...
static void ov62_0223D424 (UnkStruct_0208C06C * param0)
{
    ...
    sub_0200D4C4(v0->unk_A4[0].unk_08, 32, 232);
    sub_0200D4C4(v0->unk_A4[1].unk_08, 128, 232);
    sub_020128C4(v0->unk_A4[0].unk_0C, 36, -8);
    sub_020128C4(v0->unk_A4[1].unk_0C, 36, -8);
    sub_020129D0(v0->unk_A4[0].unk_0C, 0);
    ...
    case 2:
        if (ov61_0222BB48(ov62_0224112C(param0), &v1) == 1) {
        ...
        } else {
            {
                ...
                v0->unk_720.unk_08.unk_00 = IGT_GetHours(Save_PlayerData_GetIGTAddr(param0->unk_830));
                v0->unk_720.unk_08.unk_02 = IGT_GetMinutes(Save_PlayerData_GetIGTAddr(param0->unk_830));
                v0->unk_720.unk_08.unk_03 = IGT_GetSeconds(Save_PlayerData_GetIGTAddr(param0->unk_830));
