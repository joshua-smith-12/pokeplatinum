    ...
    case 2:
        if (ov61_0222BB48(ov62_0224112C(param0), &v1) == 1) {
        ...
        } else {
            {
                ...
                v0->unk_720.unk_08.unk_00 = sub_0202CC58(PlayerData_GetIGTAddr(param0->unk_830));
                v0->unk_720.unk_08.unk_02 = sub_0202CC5C(PlayerData_GetIGTAddr(param0->unk_830));
                v0->unk_720.unk_08.unk_03 = sub_0202CC60(PlayerData_GetIGTAddr(param0->unk_830));
