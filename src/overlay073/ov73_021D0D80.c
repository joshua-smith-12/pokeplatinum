...
int ov73_021D0D80 (UnkStruct_020067E8 * param0, int * param1)
{
    ...
    v0->unk_08 = Save_PlayerData_GetOptionsAddr(v0->unk_04);
    v0->unk_0C = 0;
    v0->unk_10 = 0;
    v0->unk_14 = NULL;
...
int ov73_021D0F7C (UnkStruct_020067E8 * param0, int * param1)
{
    ...
    PlayerProfile_Name_StringToFlat(Save_PlayerData_GetProfileAddr(v0->unk_04), v0->unk_70->unk_18);
    PlayerProfile_SetGender(Save_PlayerData_GetProfileAddr(v0->unk_04), v0->unk_70->unk_04);
...
static BOOL ov73_021D1510 (UnkStruct_ov73_021D1058 * param0, u32 param1, int param2)
{
    ...
    case 0:
        ...
        param0->unk_58 = sub_0201D738(&param0->unk_1C, 1, param0->unk_5C, 0, 0, (Options_GetTextFrameDelay(param0->unk_08)), NULL);
        param0->unk_50 = 1;
        break;
    case 1:
