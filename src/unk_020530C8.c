...
static void sub_02053320 (UnkStruct_0203CDB0 * param0)
{
    ...
    v0 = PlayerProfile_GetGender(Save_PlayerData_GetProfileAddr(param0->unk_0C));
...
static void sub_0205338C (UnkStruct_0203CDB0 * param0)
{
...

    {
        ...
        int v2 = PlayerProfile_GetGender(Save_PlayerData_GetProfileAddr(param0->unk_0C));
...
BOOL sub_02054084 (UnkStruct_020508D4 * param0)
{
    ...
    case 0:
    {
        ...
        sub_0205D944(&v1->unk_24, Save_PlayerData_GetOptionsAddr(v0->unk_0C));
        v1->unk_38 = sub_0205D994(&v1->unk_24, v1->unk_34, Save_PlayerData_GetOptionsAddr(v0->unk_0C), 1);
        v1->unk_00 = 1;
        break;
    case 1:
