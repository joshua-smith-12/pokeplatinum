...
static void sub_0209B084 (UnkStruct_0209AD84 * param0, int param1, BOOL param2)
{
    ...
    if (sub_0201A7CC(v0) == 0) {
        ...
        sub_0205D944(v0, Save_PlayerData_GetOptionsAddr(param0->unk_00->unk_0C));
    } else {
        sub_0205D988(v0);
        sub_0200E060(v0, 0, 1024 - (18 + 12), 10);
    }

    param0->unk_58 = sub_0205D994(v0, param0->unk_08, Save_PlayerData_GetOptionsAddr(param0->unk_00->unk_0C), 1);
}
