...
static void sub_020932A4(BoxPokemon * param0, PlayerProfile * param1, int param2);
...
void sub_0209304C (Pokemon * param0, PlayerProfile * param1, int param2, int param3, int param4)
{
    sub_0209305C(&param0->box, param1, param2, param3, param4);
}

void sub_0209305C (BoxPokemon * param0, PlayerProfile * param1, int param2, int param3, int param4)
{
    switch (param2) {
    case 0:
...
static void sub_020932A4 (BoxPokemon * param0, PlayerProfile * param1, int param2)
{
    int v0 = PlayerProfile_GetTrainerID(param1);
    int v1 = PlayerProfile_GetGender(param1);
    Strbuf* v2 = PlayerProfile_GetName_NewString(param1, param2);
