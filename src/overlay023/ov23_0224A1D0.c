...
static BOOL ov23_0224A294 (int param0, int param1)
{
    ...
    if ((v0->unk_290[param0] == NULL) && (v0->unk_290[param1] != NULL)) {
        ...
        PlayerProfile_Copy(v0->unk_290[param0], (PlayerProfile *)&v0->unk_14A[param0].unk_00);
        return 1;
    }
...
void ov23_0224A77C (int param0, int param1, void * param2, void * param3)
{
    ...
    case 5:
        ...
        if (PlayerProfile_DoPlayerProfilesMatch(v0->unk_290[v1->unk_02], sub_02032EE8(v1->unk_01)) == 1) {
            ov23_0224AE60(v1->unk_02);
    ...
    case 3:
        ...
        if (v0->unk_290[v1->unk_01]) {
            if (PlayerProfile_DoPlayerProfilesMatch(v0->unk_290[v1->unk_01], sub_02032EE8(sub_0203608C())) == 1) {
...
void ov23_0224AAB0 (void)
{
    ...
    if (v0->unk_290[sub_0203608C()]) {
        ...
        PlayerProfile * v0 = PlayerProfile_New(15);
        Strbuf* v1 = Strbuf_Init(20, 15);

        GF_ASSERT(v0);
        GF_ASSERT(v1);

        PlayerProfile_Name_StringToFlat(v0, v1);
        sub_020360D0(91, v0);
        Strbuf_Free(v1);
        Heap_FreeToHeap(v0);
    }
...
void ov23_0224AB30 (int param0, int param1, void * param2, void * param3)
{
    UnkStruct_ov23_0224A294 * v0 = sub_02057518();
    int v1;
    const PlayerProfile * v2 = param2;
    Strbuf* v3;
    u8 v4 = param0;

    if (v0) {
        PlayerProfile_Copy(v2, (PlayerProfile *)v0->unk_14A[param0].unk_00);

        v3 = PlayerProfile_GetName_NewString(v2, 15);
...
void ov23_0224ABC4 (int param0, int param1, void * param2, void * param3)
{
    ...
    if (v0) {
        ...
        v0->unk_290[v3] = PlayerProfile_New(15);
        PlayerProfile_Copy((PlayerProfile *)v1->unk_00, v0->unk_290[v3]);
        v0->unk_FA[v3] = 1;
    }
}
...
void ov23_0224AC4C (void)
{
    ...
    if (v0) {
        ...
        PlayerProfile_Copy(v0, (PlayerProfile *)&v4->unk_14A[0].unk_00);
...
BOOL ov23_0224AEC4 (int param0, int param1)
{
    ...
    if (v0->unk_290[param0] == NULL) {
        PlayerProfile * v1 = sub_02032EE8(param1);

        if (v1) {
            v0->unk_290[param0] = PlayerProfile_New(15);
            PlayerProfile_Copy(v1, v0->unk_290[param0]);

            v0->unk_FA[param0] = 1;
            v0->unk_14A[param0].unk_20 = param0;

            PlayerProfile_Copy(v1, (PlayerProfile *)&v0->unk_14A[param0].unk_00);
