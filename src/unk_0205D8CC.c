...
void sub_0205D944 (UnkStruct_0205AA50 * param0, const Options * param1)
{
    sub_0200DD0C(param0->unk_00, sub_0201C290(param0), 1024 - (18 + 12), 10, Options_GetFrame(param1), 4);
    sub_0205D988(param0);
...
u8 sub_0205D994 (UnkStruct_0205AA50 * param0, Strbuf *param1, const Options * param2, u8 param3)
{
    u8 v0;
    ...
    v0 = sub_0201D738(param0, 1, param1, 0, 0, Options_GetTextFrameDelay(param2), NULL);
    return v0;
}

u8 sub_0205D9CC (UnkStruct_0205AA50 * param0, Strbuf *param1, int param2, int param3, u8 param4, int param5)
{
    sub_02002AC8(param4);
    sub_02002AE4(param5);
    sub_02002B20(0);
