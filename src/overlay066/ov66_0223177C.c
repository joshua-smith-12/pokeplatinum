...
static void ov66_02231FFC(UnkStruct_ov66_02231FB0 * param0, u32 param1, u32 param2, u32 param3, const PlayerProfile * param4, const PlayerProfile * param5, const PlayerProfile * param6, const PlayerProfile * param7, u16 param8, u16 param9, u16 param10, u16 param11, u32 param12, u32 param13, u32 param14);
...
static void ov66_02231FFC (UnkStruct_ov66_02231FB0 * param0, u32 param1, u32 param2, u32 param3, const PlayerProfile * param4, const PlayerProfile * param5, const PlayerProfile * param6, const PlayerProfile * param7, u16 param8, u16 param9, u16 param10, u16 param11, u32 param12, u32 param13, u32 param14)
{
    ...
    if (param4) {
        PlayerProfile_Name_FlatToString(param4, param0->unk_10[0]);
    }

    if (param5) {
        PlayerProfile_Name_FlatToString(param5, param0->unk_10[1]);
    }

    if (param6) {
        PlayerProfile_Name_FlatToString(param6, param0->unk_10[2]);
    }

    if (param7) {
        PlayerProfile_Name_FlatToString(param7, param0->unk_10[3]);
    }
}
