...
static void ov70_0225F95C(SysTask *param0, void *param1)
{
    ...
    {
        sub_02006E84(BattleObj_GetNARCIndex(), BattleObj_GetPaletteNARCMember(), 4, 11 * 32, 3 * 32, v0->unk_156);
    }
...
static void ov70_0225FDA0(UnkStruct_ov70_0225F350 *param0, UnkStruct_ov70_0225FA84 *param1, UnkStruct_ov70_0225E4EC *param2, u32 param3, const UnkStruct_ov66_0222E71C *param4)
{
    ...
    for (v1 = 0; v1 < 2; v1++) {
        ...
        if (v0 != 0) {
            v2 = ov66_022316E8(v0);
            v3 = sub_02006FE8(BattleObj_GetNARCIndex(), BattleObj_TypeIDToNARCMember(v2), 1, param3, 1);
            ...
            sub_02019E2C(param2->unk_00, Unk_ov70_0226D5CC[3], 26, 2 + (2 * v1), 4, 2, 11 + BattleObj_TypeIDToPaletteIndex(v2));
