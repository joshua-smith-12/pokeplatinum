...
static UnkStruct_02098C44 * sub_0203D344 (int param0, UnkStruct_0203CDB0 * param1, int param2, int param3)
{
    ...
    v0->unk_0C = PlayerData_GetOptionsAddr(param1->unk_0C);
    v0->unk_21 = param2;
    v0->unk_20 = param3;
    v0->unk_1C = param1;
...
void * sub_0203D5C8 (int param0, UnkStruct_0203CDB0 * param1, int param2)
{
    ...
    v0->unk_00 = Party_GetFromSavedata(param1->unk_0C);
    v0->unk_04 = PlayerData_GetOptionsAddr(param1->unk_0C);
    v0->unk_11 = 1;
    v0->unk_14 = param2;
...
UnkStruct_02098D38 * sub_0203D670 (UnkStruct_0203CDB0 * param0, int param1, int param2)
{
    ...
    sub_0208D720(v0, v2);
    sub_0208E9C0(v0, PlayerData_GetProfileAddr(v1));
...
void * sub_0203D8EC (UnkStruct_0203CDB0 * param0)
{
    ...
    v1 = PlayerData_GetOptionsAddr(sub_0203D174(param0));
...
static UnkStruct_0203DA00 * sub_0203DA00 (int param0, UnkStruct_021C0794 * param1, int param2, BOOL * param3, BOOL param4)
{
    ...
    v0->unk_04 = v4;
    v0->unk_08 = v5;
    v0->unk_0C = PlayerData_GetOptionsAddr(param1);
    v0->unk_10 = sub_0202CD88(param1);
    v0->unk_14 = PlayerData_GetProfileAddr(param1);
    v0->unk_18 = param3;
    v0->unk_1C = param4;
...
{
    param0->unk_04 = PlayerData_GetProfileAddr(param1->unk_0C);
    ...
    param0->unk_18 = PlayerData_GetOptionsAddr(param1->unk_0C);
...
BOOL sub_0203DBF0 (UnkStruct_020508D4 * param0)
{
    ...
    case 4:
        ...
        v2->unk_48.unk_14 = PlayerData_GetOptionsAddr(v1->unk_0C);
        v2->unk_48.unk_10 = 1;
    ...
    case 5:
    {
        ...
        if ((v4 = sub_02076B94(NULL, v2->unk_04.unk_40, 1, v3, &v5)) != 0) {
            ...
            v2->unk_60 = sub_0207AE68(NULL, v2->unk_04.unk_40, v4, PlayerData_GetOptionsAddr(v1->unk_0C), sub_0208C324(v1->unk_0C), sub_02027560(v1->unk_0C), sub_0207D990(v1->unk_0C), sub_0202CD88(v1->unk_0C), sub_02056B24(v1->unk_0C), v5, 0x4, 26);
            v2->unk_00 = 6;
        } else {
            v2->unk_00 = 7;
        }
...
void sub_0203DDFC (UnkStruct_0203CDB0 * param0)
{
    ...
    v0->unk_08 = PlayerData_GetOptionsAddr(param0->unk_0C);
...
static void sub_0203DF68 (UnkStruct_020508D4 * param0)
{
    ...
    case 0:
    {
        UnkStruct_02025E6C * v2 = PlayerData_GetProfileAddr(v0->unk_0C);
...
void sub_0203DFE8 (UnkStruct_020508D4 * param0, int param1, int param2, int param3, int param4, const u16 * param5, u16 * param6)
{
    ...
    v2->unk_04 = param4;
    v2->unk_08 = param6;
    v2->unk_0C = sub_0208712C(11, param1, param2, param3, PlayerData_GetOptionsAddr(v1->unk_0C));
...
void sub_0203E0FC (UnkStruct_0203CDB0 * param0, int param1)
{
    ...
    v0->unk_1C = PlayerData_GetProfileAddr(param0->unk_0C);
    v0->unk_24 = PlayerData_GetOptionsAddr(param0->unk_0C);
...
void * sub_0203E1AC (UnkStruct_0203CDB0 * param0, int param1, int param2)
{
    ...
    v0->unk_10 = PlayerData_GetOptionsAddr(param0->unk_0C);
...
void sub_0203E2FC (UnkStruct_0203CDB0 * param0)
{
    ...
    v0.unk_00 = v2;
    v0.unk_04 = PlayerData_GetOptionsAddr(param0->unk_0C);
    v0.unk_08 = PlayerData_GetProfileAddr(param0->unk_0C);
...
static BOOL sub_0203E35C (UnkStruct_020508D4 * param0)
{
    ...
    case 1:
        if (sub_020509B4(v0) == 0) {
            u16 * v5 = PlayerData_GetCoinsAddr(v0->unk_0C);
            s64 v6 = sub_020138EC();

            sub_0206DD38(v0, Coins_GetValue(v5), v2->unk_00, sub_0201398C(v2->unk_04, v6) / 60);
            Coins_SetValue(PlayerData_GetCoinsAddr(v0->unk_0C), v2->unk_00);
...
{
    UnkStruct_0203CDB0 * v0 = sub_02050A60(param0);
    UnkStruct_020279FC * v1 = PlayerData_GetOptionsAddr(v0->unk_0C);
    UnkStruct_0203E35C * v2 = Heap_AllocFromHeap(32, sizeof(UnkStruct_0203E35C));

    v2->unk_0C.unk_00 = &v2->unk_00;
    v2->unk_00 = Coins_GetValue(PlayerData_GetCoinsAddr(v0->unk_0C));
...
UnkStruct_02098C44 * sub_0203E598 (UnkStruct_0203CDB0 * param0, int param1, int param2)
{
    ...
    v0->unk_0C = PlayerData_GetOptionsAddr(param0->unk_0C);
