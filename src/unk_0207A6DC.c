...
static void sub_0207ADD4(PlayerProfile * param0, UnkStruct_02027F8C * param1, UnkStruct_02027F8C * param2);
...
BOOL sub_0207A960 (UnkStruct_0207A778 * param0)
{
    ...
    v0 = (PlayerProfile *)&param0->unk_20[0];
    PlayerProfile_Copy(param0->unk_00->unk_D0[0], v0);
...
BOOL sub_0207A988 (UnkStruct_0207A778 * param0)
{
    ...
    return sub_0203597C(25, (void *)&param0->unk_20[0], PlayerProfile_sizeof());
}
