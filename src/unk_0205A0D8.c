...
static void sub_0205A164 (UnkStruct_0205A0D8 * param0, int param1)
{
    ...
    v1->unk_0C = Save_PlayerData_GetOptionsAddr(param0->unk_24->unk_0C);
...
static int sub_0205AA50 (UnkStruct_0205A0D8 * param0, const Strbuf *param1)
{
    ...
    if (sub_0201A7CC(v0) == 0) {
        ...
        sub_0205D944(v0, Save_PlayerData_GetOptionsAddr(param0->unk_24->unk_0C));
    } else {
        sub_0205D988(v0);
    }

    return sub_0205D994(v0, (Strbuf *)param1, Save_PlayerData_GetOptionsAddr(param0->unk_24->unk_0C), 1);
}
...
static BOOL sub_0205B140 (UnkStruct_020508D4 * param0)
{
    ...
    case 0:
        ...
        sub_0205D944(&v1->unk_08, Save_PlayerData_GetOptionsAddr(v0->unk_0C));

        v1->unk_20 = sub_0205D994(&v1->unk_08, v1->unk_04, Save_PlayerData_GetOptionsAddr(v0->unk_0C), 1);
        v1->unk_28++;
        break;
    case 1:
