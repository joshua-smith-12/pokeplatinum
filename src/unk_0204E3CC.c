...
BOOL sub_0204E45C (UnkStruct_0203E724 * param0)
{
    ...
    GF_ASSERT(v0 < 8);
    * v1 = sub_02025F34(PlayerData_GetProfileAddr(param0->unk_34->unk_0C), v0);
...
BOOL sub_0204E4A4 (UnkStruct_0203E724 * param0)
{
    ...
    GF_ASSERT(v0 < 8);
    sub_02025F48(PlayerData_GetProfileAddr(param0->unk_34->unk_0C), v0);
...
BOOL sub_0204E504 (UnkStruct_0203E724 * param0)
{
    ...
    for (v0 = 0, v1 = 0; v0 < 8; v0++) {
        if (sub_02025F34(PlayerData_GetProfileAddr(param0->unk_34->unk_0C), Unk_020EC064[v0]) == 1) {
            v1++;
        }
    }
