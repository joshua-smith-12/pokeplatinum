...
static void ov109_021D4300 (UnkStruct_ov109_021D5140 * param0, NARC * param1)
{
    ...
    sub_0200DD0C(v0, 0, 1, 10,
                 Options_GetFrame(param0->unk_0C->unk_14.unk_10), 95);
...
static BOOL ov109_021D537C (UnkStruct_0205AA50 * param0, int param1, u32 param2, UnkStruct_ov109_021D5140 * param3)
{
    ...
    for (v0 = 0; v0 < 5; v0++) {
        if (param3->unk_3D8[v0][0] != NULL) {
            u16 v3 = PlayerProfile_GetTrainerID_VisibleHalf(param3->unk_3D8[v0][0]);

            PlayerProfile_Name_FlatToString(param3->unk_3D8[v0][0], param3->unk_3C[v0]);
...
static BOOL ov109_021D54CC (UnkStruct_ov109_021D5140 * param0)
{
    ...
    for (v0 = 0; v0 < 5; v0++) {
        ...
        if (param0->unk_3D8[v0][0] != NULL) {
            param0->unk_4AC4[v0][0].val2.unk_00 = PlayerProfile_GetTrainerID(param0->unk_3D8[v0][0]);
...
static void ov109_021D5668 (UnkStruct_ov109_021D5140 * param0)
{
    ...
    for (v0 = 0; v0 < 5; v0++) {
        ...
        case 1:
        {
            ...
            v3 = PlayerProfile_GetGender(param0->unk_3D8[v0][0]);
            v2 = PlayerProfile_GetAvatar(param0->unk_3D8[v0][0]);
        ...
        case 3:
            if (sub_0203608C() == v0) {
                int v4 = PlayerProfile_GetGender(param0->unk_3D8[v0][0]);
