...
int ov113_0225CA04 (UnkStruct_020067E8 * param0, int * param1)
{
    ...
    case 3:
        ...
        v0->unk_C8 = sub_0201D738(&v0->unk_B4, 1, v0->unk_C4, 0, 0, Options_GetTextFrameDelay(Save_PlayerData_GetOptionsAddr(v0->unk_04)), NULL);
        (*param1)++;
        break;
    case 4:
...
static void ov113_0225D160 (UnkStruct_ov113_0225DBCC * param0, NARC * param1)
{
    ...
    {
        int v2;
        v2 = Options_GetFrame(Save_PlayerData_GetOptionsAddr(param0->unk_04));
