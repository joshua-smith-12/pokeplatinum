...
static UnkStruct_0205B43C * sub_0205B3A0 (UnkStruct_0203CDB0 * param0)
{
    ...
    v2->unk_00 = param0;
    v2->unk_04 = v1;
    v2->unk_08 = Save_PlayerData_GetProfileAddr(v1);
...
void sub_0205BA08 (int param0, int param1, void * param2, void * param3)
{
    ...
    PlayerProfile * v2 = sub_02032EE8(sub_0203608C() ^ 1);
    void * v3;
    ...
    if (param0 != sub_0203608C()) {
        v3 = sub_0202C0EC((u16 *)PlayerProfile_GetName(v2), PlayerProfile_GetGender(v2), 31);
...
u8 sub_0205BE38 (void)
{
    ...
    GF_ASSERT(v1 != NULL);
    v0 = PlayerProfile_GetVersion(v1);
...
static void sub_0205BE58 (UnkStruct_0205B4F8 * param0, int param1)
{
    ...
    for (v1 = 1; v1 < 4 + 1; v1++) {
        ...
        if (v0 != NULL) {
            if (sub_0203608C() == 0) {
                param0->unk_00[v3] = PlayerProfile_GetTrainerID(v0);
                param0->unk_18[v3] = PlayerProfile_GetAvatar(v0) | (PlayerProfile_GetGender(v0) << 7);
            }
        } else {
            param0->unk_00[v3] = 0;
            param0->unk_18[v3] = 0;
...
int sub_0205BF44 (UnkStruct_0205B43C * param0, UnkStruct_0200B358 * param1)
{
    ...
    if (sub_02014C80(&param0->unk_178) != 4) {
        int v4 = PlayerProfile_GetAvatar(param0->unk_08);
        int v5 = PlayerProfile_GetGender(param0->unk_08);
...
void sub_0205C040 (UnkStruct_0200B358 * param0, int param1, int param2, PlayerProfile * param3, UnkStruct_02014EC4 * param4)
{
    PlayerProfile * v0;
    Strbuf* v1;
    ...
    v3 = PlayerProfile_GetLanguage(v0);
...
void * sub_0205C17C (UnkStruct_0205B43C * param0)
{
    ...
    sub_02071D40(0, 0, 0, sub_0205CA14(PlayerProfile_GetGender(param0->unk_08), PlayerProfile_GetAvatar(param0->unk_08), 0), param0->unk_00, param0->unk_184);
