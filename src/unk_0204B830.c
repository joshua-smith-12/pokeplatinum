...
static void sub_0204BA88 (UnkStruct_0204B830 * param0, u16 * param1, u16 * param2)
{
    ...
    *param2 = 13;
    ...
    sub_0200B498(param0->unk_04, 0, Save_PlayerData_GetProfileAddr(param0->unk_00->unk_0C));
}
...
static void sub_0204BAAC (UnkStruct_0203CDB0 * param0, void * param1)
{
    ...
    if (v0->val1.unk_00 == 0) {
        Strbuf* v15 = PlayerProfile_GetName_NewString(v1, 32);
        u32 v16 = PlayerProfile_GetTrainerID(v1);
        u32 v17 = PlayerProfile_GetGender(v1);
