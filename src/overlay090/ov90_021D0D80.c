...
int ov90_021D0D80 (UnkStruct_020067E8 * param0, int * param1)
{
    ...
    v0->unk_08 = v1->unk_04;
    v0->unk_0A = v1->unk_06;
    v0->unk_18 = Save_PlayerData_GetOptionsAddr(v1->unk_00);
...
static void ov90_021D1340 (UnkStruct_ov90_021D0ECC * param0)
{
    ...
    if (param0->unk_08 == 0) {
        for (v0 = 0; v0 < 5; v0++) {
            ...
            sub_0201ADA4(&param0->unk_6C[v0], (((0 << 4) | 0)));
        }
    } else {
        for (v0 = 0; v0 < 3; v0++) {
    ...
    sub_02002E7C(0, 2 * 32, param0->unk_00);
}
...
static void ov90_021D14C8 (UnkStruct_ov90_021D0ECC * param0, UnkStruct_0205AA50 * param1, u8 param2, u8 param3, u8 param4)
{
    ...
    sub_0200C388(param0->unk_28.unk_04, param0->unk_28.unk_08, param0->unk_28.unk_24[4]);
...
static void ov90_021D15D0 (UnkStruct_ov90_021D0ECC * param0)
{
    ...
    case 2:
        ...
        sub_0201D78C(&param0->unk_6C[3], 0, param0->unk_28.unk_08, v0, 10, 0, ((u32)(((5 & 0xff) << 16) | ((6 & 0xff) << 8) | (((0 & 0xff) << 0)))), NULL);
...
static void ov90_021D17F8 (UnkStruct_ov90_021D17F8 * param0, UnkStruct_0205AA50 * param1, Strbuf *param2, u8 param3, u8 param4, u8 param5)
{
    ...
    sub_0201ADA4(param1, (((0 << 4) | 0)));

    if (param3 >= (10 - 2)) {
        v4 = 2;
        v5 = (40 - sub_02002D7C(0, param2, 0)) / 2;
        sub_0201D78C(param1, 0, param2, 2 * 72 + 16 + v5, 2 * 24 + 4, 0xff, ((u32)(((1 & 0xff) << 16) | ((2 & 0xff) << 8) | (((0 & 0xff) << 0)))), NULL);
    } else {
        v4 = 3;
    }
    ...
    for (v1 = 0; v1 < v4; v1++) {
        for (v2 = 0; v2 < 3; v2++) {
            ...
            if (v0->unk_04) {
                v6 = ((u32)(((11 & 0xff) << 16) | ((12 & 0xff) << 8) | (((0 & 0xff) << 0))));
            } else {
                v6 = ((u32)(((9 & 0xff) << 16) | ((10 & 0xff) << 8) | (((0 & 0xff) << 0))));
            }

            sub_0201D78C(param1, 0, v0->unk_00, v2 * 72, v1 * 24 + 4, 0xff, v6, NULL);
        }
    }
...
static void ov90_021D1984 (UnkStruct_ov90_021D0ECC * param0)
{
    ...
    if (v0->unk_05 == 0) {
        ...
        sub_0200C388(param0->unk_28.unk_04, param0->unk_28.unk_08, param0->unk_28.unk_1C);
        ...
        sub_0200C388(param0->unk_28.unk_04, param0->unk_28.unk_08, param0->unk_28.unk_18);
        sub_0201D78C(&param0->unk_6C[2], 0, param0->unk_28.unk_08, 0, 4, 0, ((u32)(((1 & 0xff) << 16) | ((2 & 0xff) << 8) | (((0 & 0xff) << 0)))), NULL);
    }
...
static void ov90_021D1ABC (UnkStruct_ov90_021D0ECC * param0)
{
...

    {
        ...
        UnkStruct_ov104_022412F4 v1 = {
            1, 2048, 2048, GX_OBJVRAMMODE_CHAR_1D_32K, GX_OBJVRAMMODE_CHAR_1D_32K,
        };
