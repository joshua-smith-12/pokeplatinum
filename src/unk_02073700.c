...
void sub_02073700 (UnkStruct_021C0794 * param0, int param1, UnkStruct_ov96_0223B450_sub1 * param2)
{
    ...
    MI_CpuCopy8(PlayerProfile_GetName(v1), param2->unk_A8, 8 * 2);
    *((u32 *)param2->unk_BC) = PlayerProfile_GetTrainerID(v1);

    param2->unk_B8 = Unk_020E4C40;
    param2->unk_B9 = Unk_020E4C44;
    param2->unk_BA = (u8)sub_0202C8C0(v2);
    param2->unk_BB = (u8)sub_0202C8C4(v2);
    param2->unk_C8_val1_1 = PlayerProfile_GetGender(v1);
    param2->unk_C9 = sub_0205CA14(param2->unk_C8_val1_1, PlayerProfile_GetAvatar(v1), 1);
