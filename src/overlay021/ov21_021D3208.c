...
void ov21_021D3208 (UnkStruct_ov21_021D3320 * param0, UnkStruct_ov21_021D3208 * param1, int param2)
{
    ...
    param0->unk_174C = PlayerProfile_GetVersion(param1->unk_04);
    param0->unk_1750 = PlayerProfile_GetGender(param1->unk_04);
    param0->unk_1754 = PlayerProfile_GetName_NewString(param1->unk_04, param2);
