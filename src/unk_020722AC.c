...
void sub_020722AC (void * param0, int * param1)
{
    ...
    v0->unk_19 = 0;
    v0->unk_1A = 0xFF;
    v0->unk_16 = Options_GetTextFrameDelay(Save_PlayerData_GetOptionsAddr(v1));
    v0->unk_14 = Options_GetFrame(Save_PlayerData_GetOptionsAddr(v1));
...
static int sub_02073524 (UnkStruct_02072334 * param0, int param1)
{
    ...
    case 0:
        ...
        v0->unk_0C = Save_PlayerData_GetOptionsAddr(sub_0203D174(param0->unk_16C));
