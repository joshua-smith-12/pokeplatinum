...
static void ov88_0223D0D4(PlayerProfile * param0, UnkStruct_02027F8C * param1, UnkStruct_02027F8C * param2);
...
static void ov88_0223B320 (UnkStruct_02095E80 * param0)
{
    ...
    v0 = PlayerProfile_GetName_NewString(v3, 26);
    v1 = PlayerProfile_GetName_NewString(v4, 26);
...
static void ov88_0223B3C0 (UnkStruct_02095E80 * param0)
{
    ...
    sub_0200DD0C(param0->unk_174, 0, (512 - (9 + (18 + 12))), 10, Options_GetFrame(param0->unk_08->unk_18), 26);
...
static void ov88_0223C370 (UnkStruct_02095E80 * param0, UnkStruct_020067E8 * param1)
{
    ...
    param0->unk_18C = PlayerProfile_GetName_NewString(v0->unk_04, 26);
...
static void ov88_0223D0D4 (PlayerProfile * param0, UnkStruct_02027F8C * param1, UnkStruct_02027F8C * param2)
{
    ...
    sub_020021B0(param2->unk_00, PlayerProfile_GetName(param0));

    param2->unk_10 = PlayerProfile_GetTrainerID(param0);
    param2->unk_14 = PlayerProfile_GetLanguage(param0);
    param2->unk_15 = PlayerProfile_GetVersion(param0);
    param2->unk_16 = PlayerProfile_GetGender(param0);
...
static int ov88_0223D5B8 (UnkStruct_02095E80 * param0)
{
    ...
    default:
        ...
        {
            PlayerProfile * v2 = PlayerProfile_New(26);

            PlayerProfile_SetName(v2, sub_0202AEF0(param0->unk_36EC, v0));
...
static void ov88_0223E694 (Party * param0, Party * param1, int param2, int param3, UnkStruct_ov88_0223C370 * param4)
{
    ...
    PlayerProfile_Copy(sub_02032EE8(sub_0203608C() ^ 1), param4->unk_38);
...
{
    void * v0;
    PlayerProfile * v1 = sub_02032EE8(sub_0203608C() ^ 1);
    u16 v2[10 + 1];

    GetMonData(param1, MON_DATA_117, v2);
    v0 = sub_0202C11C((u16 *)PlayerProfile_GetName(v1), PlayerProfile_GetGender(v1), v2, sub_02075D6C(param1), 26);
