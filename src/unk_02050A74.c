    ...
    if ((v1 == BATTLE_TYPE_WILD_MON)
        ...
        if (v2 == 0x1) {
            ...
            if (param0->unk_78.unk_02 >= 5) {
                v0 = Party_GetPokemonBySlotIndex(param1->parties[1], 0);
                v3 = sub_0202BECC(PlayerData_GetIGTAddr(param0->unk_0C), GetMonData(v0, MON_DATA_SPECIES, 0), GetMonData(v0, MON_DATA_111, 0), param1->unk_138, 11);
            ...
            v3 = sub_0202BE4C(PlayerData_GetIGTAddr(param0->unk_0C), GetMonData(v0, MON_DATA_SPECIES, 0), GetMonData(v0, MON_DATA_111, 0), param1->unk_138, 11);
