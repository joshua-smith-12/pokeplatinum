...
static u8 ov5_021DD574 (UnkStruct_0203E724 * param0)
{
    return Options_GetTextFrameDelay(Save_PlayerData_GetOptionsAddr(param0->unk_34->unk_0C));
}
...
static void ov5_021DD610 (UnkStruct_0203CDB0 * param0, UnkStruct_ov5_021DD648 * param1)
{
    if (*(param1->unk_10) == 0) {
        ...
        sub_0205D944(param1->unk_0C, Save_PlayerData_GetOptionsAddr(param0->unk_0C));
        *(param1->unk_10) = 1;
    }
